...
export const BUDGET_SUBJECT_CATALOG: readonly BudgetSubjectDefinition[] = [
  def("总营业收入", G.收入, "万元", "wan", "revenue", "门店整体营业收入，可由下方收入项汇总，也可作为老板预算总目标录入。", {
    financialKey: "营业收入",
    legacyKeys: ["营业收入", "总营业收入"]
  }),
  def("客房收入", G.收入, "万元", "wan", "revenue", "酒店客房销售收入。", { financialKey: "客房收入" }),
  def("餐饮收入", G.收入, "万元", "wan", "revenue", "餐厅、早餐、包间、宴请、堂食、外卖等餐饮收入。", {
    financialKey: "餐饮收入"
  }),
  def("商品/零售收入", G.收入, "万元", "wan", "revenue", "小商品、伴手礼、酒水零售等收入。", { financialKey: "其他收入" }),
  def("会议/场地收入", G.收入, "万元", "wan", "revenue", "会议室、活动场地、团建场地等收入。"),
  def("其他收入", G.收入, "万元", "wan", "revenue", "停车、洗衣、赔偿、杂项收入等。"),
  ...
  def("堂食收入", G.餐饮, "万元", "wan", "revenue", "餐厅堂食收入。"),
  def("外卖收入", G.餐饮, "万元", "wan", "revenue", "美团、饿了么、自营外卖等收入。"),
  def("包间/宴请收入", G.餐饮, "万元", "wan", "revenue", "包间、宴请、团餐等收入。"),
  ...
  def("原材料成本", G.餐饮, "万元", "wan", "cost", "食材、调料、饮品原料等成本。", { financialKey: "原材料成本" }),
  def("原材料成本率", G.餐饮, "%", "percent", "cost", "原材料成本 / 餐饮收入。"),
  def("总成本", G.成本, "万元", "wan", "cost", "经营成本总额。"),
  def("人力成本", G.成本, "万元", "wan", "cost", "工资、社保、奖金、临时工等。", { financialKey: "人力成本" }),
  def("能源费用", G.成本, "万元", "wan", "cost", "水、电、燃气、供暖等。", { financialKey: "能源费用" }),
  def("华住管理费", G.成本, "万元", "wan", "cost", "加盟管理费、品牌管理费、系统相关费用等。", {
    financialKey: "华住管理费"
  }),
  def("客房服务成本", G.成本, "万元", "wan", "cost", "布草、清洁用品、客耗品、客房维护等。", {
    financialKey: "客房服务成本"
  }),
  def("非客房服务成本", G.成本, "万元", "wan", "cost", "前厅、公共区域、行政后勤等非客房直接服务成本。", {
    financialKey: "非客房服务成本"
  }),
  def("餐饮人工成本", G.成本, "万元", "wan", "cost", "厨师、服务员、后厨、小时工等餐饮人工成本。"),
  def("餐饮能耗成本", G.成本, "万元", "wan", "cost", "餐饮水电气、厨房能源等。"),
  def("维修维护成本", G.成本, "万元", "wan", "cost", "设备维修、工程维护、房间维修等。"),
  def("洗涤成本", G.成本, "万元", "wan", "cost", "布草洗涤、制服洗涤等。"),
  def("低值易耗品成本", G.成本, "万元", "wan", "cost", "一次性用品、小工具、消耗品等。"),
  def("采购成本", G.成本, "万元", "wan", "cost", "日常采购支出，可与具体成本科目并行管理。"),
  def("销售费用", G.费用, "万元", "wan", "cost", "营销推广、OTA 推广、广告、佣金等。"),
  def("OTA 佣金", G.费用, "万元", "wan", "cost", "线上渠道佣金。"),
  def("市场推广费", G.费用, "万元", "wan", "cost", "广告、活动、团购推广等。"),
  def("管理费用", G.费用, "万元", "wan", "cost", "行政、办公、管理人员、总部支持等费用。"),
  def("办公费用", G.费用, "万元", "wan", "cost", "办公用品、打印、通讯等。"),
  def("差旅交通费", G.费用, "万元", "wan", "cost", "差旅、交通、车辆使用等。"),
  def("财务费用", G.费用, "万元", "wan", "cost", "利息、手续费、贷款相关费用等。"),
  def("租金/物业费", G.费用, "万元", "wan", "cost", "租金、物业管理费等。"),
  def("税费", G.费用, "万元", "wan", "cost", "经营相关税费。"),
  def("保险费用", G.费用, "万元", "wan", "cost", "财产险、雇主责任险、公众责任险等。"),
  def("培训费用", G.费用, "万元", "wan", "cost", "员工培训、服务培训、系统培训等。"),
  def("营业利润", G.利润, "万元", "wan", "profit", "收入扣除成本费用后的经营利润。", { financialKey: "营业利润" }),
  def("GOP", G.利润, "万元", "wan", "profit", "酒店经营毛利润 Gross Operating Profit。"),
  def("净利润", G.利润, "万元", "wan", "profit", "最终净利润。"),
  def("利润率", G.利润, "%", "percent", "profit", "营业利润 / 总营业收入。", { financialKey: "利润率" }),
  def("GOP率", G.利润, "%", "percent", "profit", "GOP / 总营业收入。"),
  def("EBITDA", G.利润, "万元", "wan", "profit", "息税折旧摊销前利润，可选预算项。"),
  def("经营现金流", G.现金流, "万元", "wan", "profit", "经营活动产生的现金流。"),
  def("投资现金流", G.现金流, "万元", "wan", "cost", "装修、设备、改造等投资现金流。"),
  def("融资现金流", G.现金流, "万元", "wan", "cost", "贷款、还款、股东投入等融资现金流。"),
  def("期初现金余额", G.现金流, "万元", "wan", "profit", "预算期开始时现金余额。"),
  def("期末现金余额", G.现金流, "万元", "wan", "profit", "预算期结束时现金余额。"),
  def("应收账款余额", G.现金流, "万元", "wan", "cost", "协议客户、挂账、平台应收等。"),
  def("应付账款余额", G.现金流, "万元", "wan", "cost", "供应商、工程、采购等应付款。"),
  ...
  def("人效", G.人员, "万元/人", "wan", "operating_high", "总营业收入 / 员工人数。"),
  def("人力成本率", G.人员, "%", "percent", "cost", "人力成本 / 总营业收入。"),
  def("装修投入", G.风险, "万元", "wan", "cost", "翻新、升级、改造投入。"),
  def("设备投入", G.风险, "万元", "wan", "cost", "厨房设备、客房设备、工程设备等。"),
...
/** 泽桐-星程中山西 2026-04 示例预算值（万元/元/%/间夜等按科目 kind） */
