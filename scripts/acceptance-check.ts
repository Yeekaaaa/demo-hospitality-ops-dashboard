...
const base: (string | number)[] = [门店示例, "month", "2026-04", 300, 210, 90, 3000, 2250, 270];
const extras = OPERATING_DATA_ASSET_IMPORT_HEADERS.map((_, i) => (i % 3 === 0 ? 10 : 5));
...
descRows.push(["【经营结果】", "", "", "", ""]);
descRows.push(["经营结果", "营业收入", "revenue", "", "万元"]);
descRows.push(["经营结果", "总成本", "total_cost", "", "万元"]);
descRows.push(["经营结果", "利润", "profit", "", "万元"]);
descRows.push(["【酒店房量指标】", "", "", "", ""]);
descRows.push(["酒店房量指标", "可售房晚", "rooms_available", "", ""]);
descRows.push(["酒店房量指标", "已售房晚", "rooms_sold", "", ""]);
descRows.push(["酒店房量指标", "客房收入", "room_revenue", "", "万元"]);
